...
<section id="details_banner">
  <div class="container">
    ...
    ?>
    <div class="single_movie_details" >
      <div class="movie_left">
        <div class="single_movie_thumnail img-fluid" class="modal_btn">
          <img alt="populler movie" src="../BackEnd/p_image/<?php echo $row['image']; ?>" alt="">
          <?php echo $row['video']; ?>
        </div>
      </div>
